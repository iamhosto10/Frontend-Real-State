...
const Clientpage = ({ id }: { id: string }) => {
  ...
  const onSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      const res = await fetch(`${apiUrl}/api/propertyimages`, {
        method: "POST",
      ...
      if (!res.ok) {
        ...
        throw new Error(
          errorData.message || "Error al crear imagen de la propiedad"
        );
      }
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-gray-600 mt-1">
                Sube una imagen para enriquecer la galería de la propiedad
              </p>
            </div>
          </div>
        </div>
        ...
        {success && (
          <Card className="bg-green-50/80 backdrop-blur-sm border-2 border-green-200 p-6">
            <div className="flex items-center gap-3 text-green-700">
              ...
              <div>
                <h3 className="font-semibold">¡Imagen añadida exitosamente!</h3>
        ...
        {error && (
          <Card className="bg-red-50/80 backdrop-blur-sm border-2 border-red-200 p-6">
            <div className="flex items-center gap-3 text-red-700">
              ...
              <div>
                <h3 className="font-semibold">Error al añadir imagen</h3>
          ...
          <form onSubmit={onSubmit} className="space-y-8">
            ...
            <div className="space-y-6 pt-6 border-t border-gray-200">
              <div className="flex flex-col sm:flex-row gap-4">
                <Button
                  type="submit"
                  disabled={loading || success || !form.file.trim()}
                  size="lg"
